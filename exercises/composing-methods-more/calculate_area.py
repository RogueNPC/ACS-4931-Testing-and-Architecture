...
def get_highest_val_in_list(li):  # TODO: Rename this function to reflect what it's doing.
    m = li[0]
    for value in li:
        if value > m:
            m = value
...
li = [5, -1, 43, 32, 87, -100]
print(get_highest_val_in_list(li))

############################
def extract_words(sentence):  # TODO: Rename this function to reflect what it's doing.
