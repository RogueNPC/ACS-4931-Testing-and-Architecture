...
butternut_sqaush_soup = FoodInfo('butternut squash soup', 45, True, 'soup', 'North African', 
...
shirazi_salad = FoodInfo('shirazi salad', 5, True, 'salad', 'Iranian',
...
homemade_beef_sausage = FoodInfo('Home-made Beef Sausage', 60, False, 'deli', 'All',
